	...
	<div class="row text-center">
		<?php foreach($shoes as $shs) : ?>
			<div class="card ml-3 mt-4 mb-4" style="width: 16rem;">
			  <img src="<?= base_url().'assets/upload/'. $shs->gambar ?>" class="card-img-top mt-2" alt="..." style="height: 250px;">
			  <div class="card-body" style="max-width: 400px;">
			    ...
			    <?= anchor('detail-barang/'. $shs->id_brg , '<div class="btn btn-sm btn-warning">Detail</div> '); ?>
